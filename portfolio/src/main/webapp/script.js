...
function initMarkers(map){
    ...
    /* DEAREST */ 
    var dearestString = 
        '<p>I worked at <b>Dearest</b>, last spring and worked on UX/UI Design for their wallet page </p>';

    var dearestwindow = new google.maps.InfoWindow({
    ...
    var cssiwindow = new google.maps.InfoWindow({
          content: cssiString,
          maxWidth: 200
    });
    ...
    var beamwindow = new google.maps.InfoWindow({
          content: beamString,
          maxWidth: 200
    });
    ...
    var nexthealthwindow = new google.maps.InfoWindow({
